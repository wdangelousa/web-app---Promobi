        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 md:h-24 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
                    {/* Alterado de <Link> para <a> para forçar o hard navigation na área protegida */}
                    <a
                        href="/admin/dashboard"
                        className="flex items-center gap-1.5 text-slate-500 hover:text-[#B8763E] transition-colors font-bold text-xs cursor-pointer"
                    >
                    ...
                    >
                        <nav className="flex flex-col p-4 space-y-3 text-center">
                            ...
                            <a
                                href="/admin/dashboard"
                                onClick={toggleMenu}
                                className="flex items-center justify-center gap-2 text-slate-600 hover:text-[#B8763E] font-bold py-2 transition-colors cursor-pointer"
                            >
